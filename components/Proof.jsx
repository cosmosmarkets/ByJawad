...
export default function Proof() {
  return (
    <section id="proof" className="py-24 lg:py-28 bg-cream-muted border-y border-forest/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10">
          {proof.map((card) => (
            <article key={card.stat} className="bg-white border border-forest/12 rounded-sm p-6">
