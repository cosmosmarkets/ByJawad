  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-10">
        <p className="text-xs uppercase tracking-[0.14em] text-ink/55 mb-6 flex justify-center flex-wrap gap-x-3 gap-y-1">
        ...
        <h1 className="font-display tracking-[-0.025em] leading-[1.06] text-[clamp(2.2rem,6.5vw,4.8rem)] mb-8 max-w-3xl mx-auto">
        ...
        <p className="text-lg leading-[1.7] text-ink/80 max-w-2xl mx-auto mb-3">
          I design and build high-conversion portfolio sites for photographers,
          designers, illustrators, and studios.
        </p>
        <p className="text-sm text-forest font-medium mb-10">
          Built with modern stack + clear messaging, so your best work gets seen faster.
        </p>
        <div className="flex flex-wrap justify-center items-center gap-4">
          <a href="#intake-form" className="inline-flex items-center justify-center px-7 py-3 bg-forest text-cream text-sm font-semibold rounded-sm">
            Start your project
          </a>
